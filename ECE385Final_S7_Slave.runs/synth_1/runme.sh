...
HD_PWD='/home/ztn/Embedded/ECE385Final_S7_Slave/ECE385Final_S7_Slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ece385final_s7_slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ece385final_s7_slave.tcl
