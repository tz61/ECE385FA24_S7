...
HD_PWD='/home/ztn/Embedded/ECE385Final_S7_Slave/ECE385Final_S7_Slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ece385final_s7_slave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ece385final_s7_slave.tcl -notrace
