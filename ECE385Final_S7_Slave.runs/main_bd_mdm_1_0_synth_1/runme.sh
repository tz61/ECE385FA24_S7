...
HD_PWD='/home/ztn/Embedded/ECE385Final_S7_Slave/ECE385Final_S7_Slave.runs/main_bd_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_bd_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_bd_mdm_1_0.tcl
